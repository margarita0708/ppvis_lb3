#include "../PPVIS_lab_3/Expression_tree.h"
#include "../PPVIS_lab_3/Assign_expression.h"
#include "../PPVIS_lab_3/Math_expression.h"
#include "../PPVIS_lab_3/Assign_expression.h"
	...
	TEST_CLASS(Testing_Assignemnt)
	{
		TEST_METHOD(assign_test_1)
		{
			...
			if (assigment.is_assgignment(line))
				assigment.do_assign(line);
			line = "a^2";
			line = assigment.assignment(line);
